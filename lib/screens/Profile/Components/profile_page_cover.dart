        ...
        return Stack(
          ...
          Positioned(
                  ...
                  child:  CircularProfileAvatar(
                          ...
                          initialsText: Text(
                            controller.profiledetails?.length >0 ? controller.profiledetails[0].fname[0]:'',
                        ...
                        child: Container(
                              ...
                              // alignment: Alignment.center,
                              child: Text(controller.profiledetails?.length >0 ? '${controller.profiledetails[0].fname}':'',
                        ...
                        child: Container(
                              ...
                              child: Text(inst.profiledetails?.length >0 ? '${controller.profiledetails[0].bio}':'',
